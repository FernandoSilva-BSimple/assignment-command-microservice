...
public class PublishAssignmentCreatedAsyncTests
{
    [Fact]
    public async Task PublishAssignmentCreatedAsync_ShouldCallPublish_WithCorrectData()
    {
        // Arrange
        ...
        // Act
        await publisher.PublishAssignmentCreatedAsync(assignmentId, deviceId, collaboratorId, period);
